from admin_improved import Admin
...
# Demonstrates Encapsulation data protection rules
...
print("\n--- Running System Maintenance Loop (Polymorphism Showcase) ---")
for account in [user1, user2]:
    print(account.apply_yearly_update())
